...
DEFAULT_EXPORT_ROOT = BRAIN_ROOT / "EXPORTS" / "first-article-workflow"
DEFAULT_STATE_ROOT = BRAIN_ROOT / "Backside" / "_state" / "first-article-workflow"
DEFAULT_DROP = BRAIN_ROOT / "Backside" / "workflows" / "first-article.workflow" / "00_DROP"
