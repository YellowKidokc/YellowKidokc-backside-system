...
> Likely targets: T1 kernel Closure.lean (already covers reference-priority). May need an explicit Inference module showing that reasoning operations are reference-class operations.
