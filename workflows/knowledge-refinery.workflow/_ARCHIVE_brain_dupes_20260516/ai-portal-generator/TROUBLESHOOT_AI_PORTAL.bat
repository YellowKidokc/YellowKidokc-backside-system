...
for %%D in ("X:\proof-explorer" "X:\proof-explorer\reports\gtq_docker_all25_20260507_191530" "C:\Users\lowes\OneDrive\Desktop\genesis-to-quantum" "X:\brain\00_WORKFLOWS\paper-proof-grader\OUTPUT\fruits_of_spirit\fruits_run_20260507_173715") do (
  if exist %%~D (
    echo OK     %%~D
  ) else (
    echo MISSING %%~D
